...
// Module: Leantest
// Imports: Init Mathlib Init Mathlib.Algebra.Ring.Int Mathlib.Order.Bounds.Basic Mathlib.Data.Nat.Factorial.Basic Mathlib.Data.Nat.Prime.Defs Mathlib.Algebra.Order.Monoid.Unbundled.Pow
#include <lean/lean.h>
...
lean_object* initialize_Init(uint8_t builtin, lean_object*);
lean_object* initialize_Mathlib_Algebra_Ring_Int(uint8_t builtin, lean_object*);
...
LEAN_EXPORT lean_object* initialize_Leantest(uint8_t builtin, lean_object* w) {
lean_object * res;
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_Mathlib_Algebra_Ring_Int(builtin, lean_io_mk_world());
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
